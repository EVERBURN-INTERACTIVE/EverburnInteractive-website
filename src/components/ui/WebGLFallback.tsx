...
export function WebGLFallback({ assetLoadError = false }: WebGLFallbackProps) {
  return (
    <main className="webgl-fallback">
      ...
      {assetLoadError ? (
        <p>
          A 3D model failed to load. Export the missing glb files to{' '}
          <code>public/models/</code> or refresh after Blender export completes.
        </p>
      ) : (
